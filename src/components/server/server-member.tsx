...
export const ServerMember = ({ member, server }: ServerMemberProps) => {
    ...
    return (
        <button onClick={onClick} className={cn("group px-2 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition mb-1",
